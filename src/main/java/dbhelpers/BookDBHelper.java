...
public class BookDBHelper {
    ...
    public String getHTMLTable(ResultSet results){
        ...
        try {
            while(results.next()) {
                ...
                // Create a hyperlink for the author
                table +="<td>";
                table += "<a href='filterByAuthor?author=" + book.getAuthor() + "'>" + book.getAuthor() + "</a>";
                table += "</td>";
                
                //table += book.getAuthor();
               //  table += "<input type=\"button\"  class=\"button-like-link\" name=\"bookID\" value=\"" + book.getAuthor() + "\">";
                table +="</td>";
                table +="<td>";
                table += book.getPages();
                table +="</td>";
	...
	public ResultSet doReturnAuthor(String author) {
